...
AppState.States = {
    ...
    ACTION_SCALE_ORIGIN_START: {history: false},
    ACTION_SCALE_ORIGIN_PROGRESS: {history: false},
    ACTION_SCALE_ORIGIN_STOP: {history: false},
    ...
    ACTION_OPEN_DIALOG_EXPORT_PROJECT_START: {history: false},
    ACTION_OPEN_DIALOG_EXPORT_PROJECT_PROGRESS: {history: false},
    ACTION_OPEN_DIALOG_EXPORT_PROJECT_STOP: {history: false},
    ...
    ACTION_ADD_TEXT_START: {history: false},
    ACTION_ADD_TEXT_PROGRESS: {history: false},
    ACTION_ADD_TEXT_STOP: {history: false},
