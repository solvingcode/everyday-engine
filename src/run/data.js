...
export {default as PreferenceData} from '../app/project/data/PreferenceData.js'
export {default as GameInputPreferenceData} from '../app/project/data/GameInputPreferenceData.js'
...
export {default as SceneData} from '../app/project/data/SceneData.js'
export {default as SceneManagerData} from '../app/project/data/SceneManagerData.js'
export {default as TagPreferenceData} from '../app/project/data/TagPreferenceData.js'
export {default as TagData} from '../app/project/data/TagData.js'
export {default as LayerGroupPreferenceData} from '../app/project/data/LayerGroupPreferenceData.js'
export {default as LayerGroupData} from '../app/project/data/LayerGroupData.js'